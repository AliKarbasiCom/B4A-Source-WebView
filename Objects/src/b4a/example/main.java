...
mostCurrent._activity.LoadLayout("mainlayout",mostCurrent.activityBA);
 //BA.debugLineNum = 30;BA.debugLine="WebView1.LoadUrl(\"https://akarbasi.ir\")";
mostCurrent._webview1.LoadUrl("https://akarbasi.ir");
 //BA.debugLineNum = 31;BA.debugLine="WebView1.Visible=False";
mostCurrent._webview1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 32;BA.debugLine="ProgressDialogShow2(\"لطفا صبور باشید ...\",False)";
...
public static String  _webview1_pagefinished(String _url) throws Exception{
 //BA.debugLineNum = 46;BA.debugLine="Sub WebView1_PageFinished (Url As String)";
 //BA.debugLineNum = 47;BA.debugLine="ToastMessageShow(\"Done!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Done!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 48;BA.debugLine="WebView1.Visible=True";
